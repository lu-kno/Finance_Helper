...
categories_dict={
                ...
                'FUN':      ['MEDIMAX', 'Nintendo', 'BLIZZARD', 'Thomas Meyer', 'LYNEX', 'Curiosityst', 'EUROBILL', 'Galeria','Bitpanda', 'LOVOO', 'STEAM GAMES', 'Fellhornbahn', 'GOOGLE', 'MINECRAFT'],
                'CLOTHING': ['Trend Star', 'SCHUHDEALER', 'Wish', 'MOUNTAIN WAREHOUSE','H\+M','TK MAXX', 'NEW YORKER', 'Bijou Brigitte', 'Hopfer \+ Hopfer', 'Woolworth','C\+A'],
                'AMAZON':   ['AMAZON'],
                'CASH_OUT':     ['Auszahlung'],
                'CASH_IN':  ['EINZAHLUNG'],
                'GIFTS':    ['Xmas'],
